...
("52228", "iPhone X", "El iPhone X presenta una pantalla Super Retina de 5.8 pulgadas, una cámara dual avanzada y reconocimiento facial con Face ID. Potenciado por un chip A11 Bionic para un rendimiento superior.", "2013-07-05", "2025-11-08", "575.0", "C001"),
("81220", "Samsung Galaxy S20", "El Samsung Galaxy S20 es un teléfono inteligente con una pantalla Dynamic AMOLED de 6.2 pulgadas, cámara de triple lente y capacidad de grabación de videos en 8K. Además, cuenta con una batería de larga duración.", "2006-01-26", "2025-02-03", "618.0", "C001"),
("32535", "Google Pixel 5", "El Google Pixel 5 es un teléfono Android con una pantalla OLED de 6 pulgadas, cámara dual con capacidad de grabación de videos en 4K y un lector de huellas dactilares trasero. Ofrece una experiencia de software limpia y actualizaciones rápidas.", "2019-02-22", "2029-11-21", "770.0", "C001"),
("63648", "OnePlus 9 Pro", "El OnePlus 9 Pro es un teléfono con una pantalla Fluid AMOLED de 6.7 pulgadas, cámara cuádruple de alta resolución y carga rápida Warp Charge. Con un potente rendimiento y una interfaz de usuario personalizable.", "2009-01-17", "2030-01-21", "809.0", "C001"),
("40297", "Xiaomi Mi 11", "El Xiaomi Mi 11 cuenta con una pantalla AMOLED de 6.81 pulgadas, una cámara triple con capacidad de grabación de videos en 8K y carga rápida de 55W. Además, incorpora un potente procesador y altavoces estéreo.", "2015-05-28", "2023-11-30", "614.0", "C001"),
("70589", "Huawei P40 Pro", "El Huawei P40 Pro ofrece una pantalla OLED de 6.58 pulgadas, cámara cuádruple Leica de alta resolución y carga inalámbrica rápida. Con un diseño elegante y potentes capacidades fotográficas.", "2015-12-22", "2030-12-14", "629.0", "C001"),
("24483", "Motorola Moto G Power", "El Motorola Moto G Power cuenta con una batería de larga duración que te permite disfrutar de hasta 3 días de uso sin necesidad de recargar. Con una pantalla de 6.4 pulgadas y un sistema de cámara triple.", "2021-08-26", "2025-08-12", "584.0", "C001"),
("56555", "Sony Xperia 1 II", "El Sony Xperia 1 II es un teléfono de gama alta con una pantalla OLED de 6.5 pulgadas y una cámara cuádruple Zeiss de alta calidad. Además, cuenta con una potente configuración de audio y una gran capacidad de almacenamiento.", "2015-02-02", "2033-01-29", "554.0", "C001"),
("43527", "LG Velvet", "El LG Velvet es un elegante teléfono con una pantalla P-OLED de 6.8 pulgadas y una cámara triple versátil. Con una gran calidad de audio y resistencia al agua y polvo.", "2018-12-09", "2023-06-18", "662.0", "C001"),
("72099", "Nokia 9 PureView", "El Nokia 9 PureView destaca por su cámara penta de 5 lentes con tecnología ZEISS y capacidad de capturar imágenes en formato RAW. Cuenta con una pantalla de 5.99 pulgadas y un diseño de vidrio y metal.", "2008-05-27", "2027-01-04", "688.0", "C001"),
("53133", "ASUS ROG Phone 5", "El ASUS ROG Phone 5 está diseñado para los amantes de los juegos móviles, con una pantalla AMOLED de 6.78 pulgadas con frecuencia de actualización de 144Hz y un potente procesador Snapdragon 888. Incluye características gaming como gatillos AirTrigger y refrigeración avanzada.", "2016-10-12", "2030-08-10", "593.0", "C001"),
("26154", "Xiaomi Redmi Note 10 Pro", "El Xiaomi Redmi Note 10 Pro ofrece una pantalla AMOLED de 6.67 pulgadas, una cámara cuádruple de alta resolución y una batería de larga duración. Con un diseño elegante y un rendimiento confiable.", "2013-10-05", "2028-05-24", "831.0", "C001"),
("36471", "Oppo Find X3 Pro", "El Oppo Find X3 Pro cuenta con una pantalla AMOLED de 6.7 pulgadas y una cámara cuádruple con capacidades avanzadas de captura de imágenes. Con un potente procesador y carga rápida SuperVOOC 2.0.", "2007-09-10", "2027-04-25", "638.0", "C001"),
("47055", "ZTE Axon 30 Ultra", "El ZTE Axon 30 Ultra es un teléfono con una pantalla AMOLED de 6.67 pulgadas, una cámara triple de alta resolución y carga rápida de 66W. Con un diseño elegante y un rendimiento excepcional.", "2021-10-08", "2029-07-01", "645.0", "C001"),
("25146", "Realme 8 Pro", "El Realme 8 Pro cuenta con una pantalla Super AMOLED de 6.4 pulgadas, una cámara cuádruple de alta resolución y una batería de larga duración. Con un diseño llamativo y un rendimiento eficiente.", "2015-08-16", "2032-09-28", "646.0", "C001"),
("51205", "Vivo X60 Pro", "El Vivo X60 Pro ofrece una pantalla AMOLED de 6.56 pulgadas, una cámara cuádruple con estabilización de imagen gimbal y carga rápida de 33W. Con un diseño elegante y un enfoque en la fotografía.", "2012-01-13", "2030-06-05", "812.0", "C001"),
("36344", "HTC U12+", "El HTC U12+ cuenta con una pantalla Super LCD de 6 pulgadas, una cámara dual con efecto bokeh y resistencia al agua", "2023-03-25", "2026-07-07", "726.0", "C001"),
("84518", "Lenovo Legion Phone Duel", "El Lenovo Legion Phone Duel es un teléfono gaming con una pantalla AMOLED de 6.65 pulgadas, un procesador Snapdragon 865 Plus y una configuración de cámara dual. Cuenta con gatillos táctiles, sistema de refrigeración y una gran capacidad de almacenamiento.", "2008-11-30", "2031-05-02", "771.0", "C001"),
("29811", "Blackberry Key2", "El Blackberry Key2 presenta un teclado físico QWERTY junto con una pantalla IPS de 4.5 pulgadas. Además, ofrece un sistema de seguridad robusto, una cámara dual y una batería de larga duración.", "2011-03-11", "2027-05-21", "775.0", "C001"),
("64705", "Honor 20 Pro", "El Honor 20 Pro es un teléfono con una pantalla OLED de 6.26 pulgadas, una cámara cuádruple con capacidad de zoom óptico y una batería de alta capacidad. Con un diseño elegante y un rendimiento eficiente.", "2022-09-14", "2035-06-09", "841.0", "C001"),
("40249", "Meizu 17 Pro", "El Meizu 17 Pro cuenta con una pantalla Super AMOLED de 6.6 pulgadas, una cámara cuádruple de alta resolución y carga rápida de 30W. Con un diseño elegante y una interfaz de usuario personalizable.", "2021-02-17", "2031-03-02", "620.0", "C001"),
("66767", "Panasonic Toughbook A3", "El Panasonic Toughbook A3 es un teléfono resistente con una pantalla de 10.1 pulgadas, diseñado para soportar condiciones difíciles y ambientes extremos. Incluye una batería de larga duración y conectividad 4G LTE.", "2010-03-15", "2024-07-09", "655.0", "C001"),
("80416", "CAT S62 Pro", "El CAT S62 Pro es un teléfono robusto con una pantalla de 5.7 pulgadas y una cámara térmica integrada. Cuenta con resistencia al agua y polvo, así como también una gran durabilidad en entornos exigentes.", "2010-12-22", "2032-01-10", "759.0", "C001"),
("12984", "Alcatel 3X", "El Alcatel 3X ofrece una pantalla IPS de 6.52 pulgadas, una cámara triple versátil y una batería de alta capacidad. Con un diseño moderno y un rendimiento equilibrado.", "2017-01-19", "2024-08-20", "713.0", "C001"),
("91086", "Infinix Zero 8", "El Infinix Zero 8 cuenta con una pantalla IPS de 6.85 pulgadas, una cámara cuádruple de alta resolución y carga rápida de 33W. Con un diseño llamativo y una gran relación calidad-precio.", "2023-02-11", "2027-04-09", "892.0", "C001"),
("62825", "Sharp Aquos R3", "El Sharp Aquos R3 presenta una pantalla IGZO de 6.2 pulgadas, una cámara dual con capacidad de grabación de videos en 4K y un procesador Snapdragon 855. Con un diseño elegante y un enfoque en la calidad de visualización.", "2015-12-06", "2034-11-21", "879.0", "C001"),
("34259", "Motorola Razr 5G", "El Motorola Razr 5G es un teléfono plegable con una pantalla Flex View de 6.2 pulgadas, una cámara de alta resolución y una gran capacidad de almacenamiento. Con un diseño icónico y funciones multitarea mejoradas.", "2008-09-20", "2028-11-19", "879.0", "C001"),
("52180", "Doogee S96 Pro", "El Doogee S96 Pro es un teléfono robusto con una pantalla de 6.22 pulgadas, una cámara cuádruple con visión nocturna y una batería de larg", "2016-05-28", "2027-08-01", "608.0", "C001"),
("87118", "MacBook Pro", "Una potente laptop diseñada por Apple que combina un rendimiento excepcional con una elegante y delgada carcasa de aluminio. Viene con una pantalla Retina de alta resolución, procesadores rápidos, amplia capacidad de almacenamiento y una duración prolongada de la batería.", "2007-03-23", "2030-06-24", "813.0", "C002"),
("36606", "Dell XPS 15", "Una laptop premium con un diseño sofisticado y una calidad de construcción excepcional. Cuenta con una pantalla InfinityEdge de borde delgado, procesadores potentes, gráficos dedicados, amplias opciones de almacenamiento y una experiencia de usuario fluida.", "2014-04-06", "2025-05-28", "668.0", "C002"),
("42539", "HP Spectre x360", "Una laptop convertible que combina estilo y funcionalidad. Con una pantalla táctil de 360 grados, este dispositivo se puede utilizar como una laptop o una tableta. Ofrece un diseño delgado y elegante, rendimiento rápido, una duración de la batería impresionante y una calidad de construcción premium.", "2018-03-29", "2029-05-20", "622.0", "C002"),
("55507", "Lenovo ThinkPad X1 Carbon", "Una laptop empresarial ultraligera y duradera diseñada para profesionales en movimiento. Viene con una pantalla de alta resolución, teclado cómodo, procesadores potentes, amplia capacidad de almacenamiento y una serie de características de seguridad avanzadas.", "2012-04-04", "2032-07-26", "809.0", "C002"),
("98459", "Microsoft Surface Book 3", "Un 2 en 1 que combina la versatilidad de una tablet con el rendimiento de una laptop. Con una pantalla desmontable de alta resolución y soporte para el Surface Pen, este dispositivo es ideal para artistas y profesionales creativos. También ofrece un rendimiento potente, batería de larga duración y una amplia variedad de opciones de conectividad.", "2006-06-19", "2032-11-04", "882.0", "C002"),
("54895", "Asus ROG Strix G15", "Una computadora portátil gaming diseñada para ofrecer un rendimiento excepcional en juegos. Cuenta con una pantalla de alta frecuencia de actualización, procesadores potentes, gráficos de alta gama, amplia capacidad de almacenamiento y un sistema de enfriamiento eficiente para sesiones de juego prolongadas.", "2011-01-07", "2025-12-01", "603.0", "C002"),
("86789", "Acer Predator Helios 300", "Otra opción popular para juegos, esta laptop ofrece un rendimiento sólido a un precio más asequible. Viene con una pantalla de alta resolución, procesadores potentes, gráficos dedicados, amplia capacidad de almacenamiento y un diseño agresivo con iluminación personalizable.", "2020-10-03", "2035-04-20", "885.0", "C002"),
("62953", "Raspberry Pi 4", "Un miniordenador de placa única que es popular entre los entusiastas de la informática y los proyectos de bricolaje. Aunque es pequeño, ofrece un rendimiento impresionante para tareas básicas y proyectos de IoT (Internet de las cosas). Tiene múltiples puertos, capacidad de reproducción de video en 4K y se puede personalizar según las necesidades del usuario.", "2008-11-05", "2035-03-25", "791.0", "C002"),
("38044", "Refrigerador", null, "2008-08-04", "2035-02-06", "673.0", "C003"),
("67658", "Lavadora", null, "2009-12-15", "2024-05-19", "888.0", "C003"),
("97876", "Secadora", null, "2020-11-07", "2027-07-30", "561.0", "C003"),
("12943", "Lavavajillas", null, "2008-04-17", "2024-02-23", "867.0", "C003"),
("56332", "Horno", null, "2015-12-04", "2035-08-08", "697.0", "C003"),
("57073", "Estufa", null, "2022-07-05", "2025-04-13", "598.0", "C003"),
("84914", "Microondas", null, "2016-12-11", "2026-01-02", "641.0", "C003"),
("16270", "Licuadora", null, "2020-01-08", "2027-01-10", "534.0", "C003"),
("92128", "Batidora", null, "2016-08-15", "2025-09-20", "630.0", "C003"),
("29884", "Tostadora", null, "2016-04-13", "2030-08-25", "751.0", "C003"),
("56687", "Cafetera", null, "2012-06-11", "2029-06-14", "808.0", "C003"),
("54151", "Freidora eléctrica", null, "2022-12-25", "2024-02-15", "778.0", "C003"),
("26411", "Aspiradora", null, "2011-04-22", "2027-03-30", "564.0", "C003"),
("84744", "Plancha", null, "2017-05-24", "2035-08-06", "739.0", "C003"),
("22482", "Hervidor eléctrico", null, "2018-05-07", "2027-05-14", "726.0", "C003"),
("25098", "Dispensador de agua", null, "2011-04-29", "2030-09-27", "508.0", "C003"),
("83994", "Máquina de hacer pan", null, "2015-05-18", "2027-12-24", "660.0", "C003"),
("36689", "Procesador de alimentos", null, "2011-11-20", "2033-05-15", "774.0", "C003"),
("27812", "Parrilla eléctrica", null, "2020-11-21", "2031-12-29", "581.0", "C003"),
("23012", "Robot aspirador", null, "2014-05-02", "2026-06-18", "702.0", "C003"),
("51884", "Máquina de café espresso", null, "2009-07-26", "2025-11-08", "634.0", "C003"),
("12127", "Deshumidificador", null, "2010-09-09", "2024-07-25", "505.0", "C003"),
("88517", "Ventilador", null, "2009-04-07", "2023-09-01", "719.0", "C003"),
("78502", "Aire acondicionado", null, "2015-12-19", "2029-05-16", "877.0", "C003"),
("27580", "Calentador de agua", null, "2007-04-29", "2033-06-26", "712.0", "C003"),
("35077", "Purificador de aire", null, "2006-04-10", "2030-11-23", "555.0", "C003"),
("93884", "Robot de cocina", null, "2016-05-14", "2026-08-20", "690.0", "C003"),
("92693", "Máquina de helados", null, "2013-10-27", "2033-02-11", "626.0", "C003"),
("92901", "Extractor de jugos", null, "2022-01-07", "2030-03-10", "751.0", "C003"),
("64545", "Licuadora de inmersión", null, "2010-09-17", "2032-04-14", "893.0", "C003"),
("69612", "Procesador (CPU)", "Es el cerebro de la computadora, encargado de ejecutar las instrucciones y realizar los cálculos necesarios para el funcionamiento del sistema.", "2013-07-25", "2027-03-16", "560.0", "C004"),
("54503", "Tarjeta madre (placa base)", "Es la principal placa de circuito impreso donde se conectan todos los componentes de la computadora. Proporciona las conexiones y circuitos necesarios para que los componentes se comuniquen entre sí.", "2009-04-26", "2030-12-14", "748.0", "C004"),
("72156", "Memoria RAM", "Es la memoria de acceso aleatorio donde se almacenan los datos y programas que están siendo utilizados activamente por la computadora. Cuanta más RAM tenga una computadora, más capacidad tendrá para ejecutar múltiples tareas simultáneamente.", "2014-09-21", "2032-12-03", "777.0", "C004"),
("94450", "Disco duro o SSD", "Es el dispositivo de almacenamiento principal de la computadora. El disco duro utiliza discos magnéticos para almacenar datos, mientras que los SSD (Unidades de Estado Sólido) utilizan memoria flash. Ambos almacenan de forma permanente los archivos y programas de la computadora.", "2007-04-02", "2032-01-25", "896.0", "C004"),
("61347", "Tarjeta de video (GPU)", "Es responsable de generar y renderizar las imágenes en la pantalla. Las tarjetas de video dedicadas son especialmente importantes para tareas gráficamente intensivas, como juegos o diseño gráfico.", "2018-01-18", "2031-07-06", "527.0", "C004"),
("73483", "Fuente de alimentación", "Proporciona energía eléctrica a todos los componentes de la computadora. Se conecta a la toma de corriente y distribuye la energía de manera segura y estable a los demás componentes.", "2020-04-26", "2027-09-18", "570.0", "C004"),
("81571", "Ventilador y disipador de calor", "Estos componentes trabajan en conjunto para mantener la temperatura de la computadora bajo control. Los ventiladores ayudan a extraer el aire caliente del interior del equipo y el disipador de calor disipa el calor generado por el procesador y otros componentes.", "2020-07-16", "2023-08-13", "822.0", "C004"),
("31219", "Tarjeta de red", "Permite la conexión a redes de datos, ya sea por cable (Ethernet) o de forma inalámbrica (Wi-Fi), para facilitar la comunicación y acceso a Internet.", "2013-10-05", "2024-12-26", "757.0", "C004"),
("21958", "Tarjeta de sonido", "Proporciona capacidades de audio a la computadora, permitiendo la reproducción y grabación de sonidos a través de altavoces, auriculares o micrófonos.", "2010-07-10", "2027-04-22", "592.0", "C004"),
("37283", "Teclado", "Dispositivo de entrada que permite al usuario introducir caracteres y comandos en la computadora mediante la pulsación de teclas.", "2021-11-02", "2031-03-07", "706.0", "C004"),
("79129", "Ratón", "Dispositivo de entrada que permite mover el cursor en la pantalla y seleccionar objetos mediante botones y desplazamiento.", "2015-08-29", "2025-10-28", "704.0", "C004"),
("48086", "Monitor", "Es el dispositivo de salida principal de la computadora, donde se muestran las imágenes y texto generados por la tarjeta de video.", "2010-04-09", "2031-03-23", "681.0", "C004");
...
create Table Voucher_servicio(
  ...
  cod_unico_emp char(5),
  unidades_totales int ,
  nombre_responsable_entrega varchar(50),
  fecha_ingreso date,
  fecha_salida date,
  costo_almacen_total decimal(5,2),
  PRIMARY KEY (`cod_Vta_Voucher`),
FOREIGN KEY (cod_unico_prod) REFERENCES Productos (cod_unico_prod),
FOREIGN KEY (cod_unico_emp) REFERENCES Empresa (cod_unico_emp),
FOREIGN KEY (cod_unico_prov) REFERENCES Proveedores (cod_unico_prov),
FOREIGN KEY (unidades_totales) REFERENCES Categoria (stk_prod)
);
